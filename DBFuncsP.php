...
class DBFuncs
	...
	function userSignup($email, $pw)
		{
		// Do proper regex testing here to sanitize.
	...
	function addProductPVersion()
		{
		$randomNum = rand(0, 9999999);
		$randomFeat = rand(0, 1);
		$sql = "INSERT INTO `Products` (`ProductID`, `ProductName`, `ProductDesc`, `UnitsInStock`, `UnitPrice`, `Image`, `Featured`) 
		VALUES (NULL, `Test Item". $randomNum."`, `Generic Description". $randomNum."`, `10`, `99.99`, ``, $randomFeat)";
	 ...
	 * defeat%
	 * 
	 * TEll Brian to check session ID against session context
	 */
